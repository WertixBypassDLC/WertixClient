...
public class MatrixRotation extends RotationMode {
    ...
    public Rotation process(Rotation currentRotation, Rotation targetRotation, Vec3d vec3d, Entity entity) {
        ...
        // Используем внутреннюю проверку: если сущность есть, значит мы в бою
        boolean isAttacking = entity != null;
        float pitchSpeed = isAttacking ? Math.abs(pitchDelta) : 0.333f;
