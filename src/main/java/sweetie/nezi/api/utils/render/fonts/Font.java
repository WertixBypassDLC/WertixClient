...
import sweetie.nezi.api.utils.render.fonts.FontData.AtlasData;
import sweetie.nezi.api.utils.render.fonts.FontData.MetricsData;
...
public final class Font {
    ...
    private Pair<Float, Float> offset(float x, float y) {
        ...
        return new Pair<>(x - scale / 2f, y - scale);
    }
